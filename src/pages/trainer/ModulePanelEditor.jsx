...
import PanelPreview           from '../../components/trainer/module-panel-editor/PanelPreview'
import AnchorContextMenu      from '../../components/trainer/module-panel-editor/AnchorContextMenu'
import TopBar                 from '../../components/trainer/module-panel-editor/TopBar'
import FloatActions           from '../../components/trainer/module-panel-editor/FloatActions'
import AddPanelMenu           from '../../components/trainer/module-panel-editor/AddPanelMenu'
import PanelStrip             from '../../components/trainer/module-panel-editor/PanelStrip'
import DeleteDialog           from '../../components/trainer/module-panel-editor/DeleteDialog'
import EditDrawer             from '../../components/trainer/module-panel-editor/EditDrawer'
import PlacementHint          from '../../components/trainer/module-panel-editor/PlacementHint'
import '../css/trainer/ModulePanelEditor.css'
...
export default function ModulePanelEditor() {
  ...
  const backPath  = state?.backPath  ?? (isAdminContext ? '/admin/courses' : '/trainer/builder')
