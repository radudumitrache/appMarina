...
import TicketForm     from '../../components/trainer/support/TicketForm'
import TicketList     from '../../components/trainer/support/TicketList'
import SupportFAQ     from '../../components/trainer/support/SupportFAQ'
import SupportContact from '../../components/trainer/support/SupportContact'
import { getTickets, createTicket } from '../../api/support'
import Sk from '../../components/shared/Skeleton'
import '../css/trainer/Support.css'
    ...
    <div className="ts-page">
      ...
      <header className="ts-header">
        <div className="ts-breadcrumb">
          <button className="ts-crumb-link" onClick={() => navigate('/trainer/dashboard')}>
            Dashboard
          </button>
