...
import TicketForm from '../../components/crew/support/TicketForm'
import TicketList from '../../components/crew/support/TicketList'
import FaqAccordion from '../../components/crew/support/FaqAccordion'
import ContactInfo from '../../components/crew/support/ContactInfo'
import { getTickets, createTicket } from '../../api/support'
import '../css/crew/Support.css'
    ...
    <div className="support-page">
      ...
      <header className="support-header">
        <div className="support-breadcrumb">
          <button className="breadcrumb-link" onClick={() => navigate('/crew/dashboard')}>
            Dashboard
          </button>
