...
import MyClassHeader      from '../../components/crew/my-class/MyClassHeader'
import ClassRoster        from '../../components/crew/my-class/ClassRoster'
import Announcements      from '../../components/crew/my-class/Announcements'
import JoinClassCard      from '../../components/crew/my-class/JoinClassCard'
import ClassSidebar       from '../../components/crew/my-class/ClassSidebar'
import ClassStatCards     from '../../components/crew/my-class/ClassStatCards'
import {
  getDepartments, getClassCrew, getClassModules,
  getClassAssignments, getAnnouncements, joinClass,
} from '../../api/departments'
import '../css/crew/MyClass.css'
...
export default function MyClass() {
  ...
  const statCards = [
    {
      label: 'Classmates',
      value: String(Math.max(0, classroom.crew_count - 1)),
    ...
    <div className="myclass-page">
      ...
      <div className="myclass-body">
        ...
        <div className="myclass-main">
          ...
          <MyClassHeader
            classInfo={classInfo}
            onBack={() => navigate('/crew/dashboard')}
          />
