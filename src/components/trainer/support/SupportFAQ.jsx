...
const FAQ = [
  { id: 1, q: 'How do I add crew members to my department?', a: 'Go to Departments, open the department detail, and use the crew member search field to enroll crew members by name or email.' },
  ...
  { id: 3, q: 'Can crew members see modules before I assign them?', a: 'Only public modules are visible to all crew members. Department-visibility modules are only accessible to crew members enrolled in a department they are assigned to.' },
