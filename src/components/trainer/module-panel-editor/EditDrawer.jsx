...
import { createPanelDocument, deletePanelDocument } from '../../../api/modules'
    ...
    items: [
      ...
      },
      {
        ...
        act: e => {
          const { empty } = e.state.selection
          if (empty) {
            // No selection â€” expand to the whole current node first
...
export default function EditDrawer({
  ...
  onDrawerWidthChange,
  onSave, onClose, saving, moduleId, departmentId, departmentLabel, panels,
  ...
  const handleDocUpload = async (fileData) => {
    ...
    try {
      const res = await createPanelDocument(moduleId, panel.id, fileData)
  ...
  const handleDocDelete = async (docId) => {
    await deletePanelDocument(moduleId, panel.id, docId)
    setPanelDocs(prev => prev.filter(d => d.id !== docId))
  }
  const dragStartX     = useRef(0)
  const dragStartWidth = useRef(0)

  // â”€â”€ Dirty detection â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
