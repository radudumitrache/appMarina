  ...
  return (
    <div className="sp-section">
      <div className="sp-section-head">
        <span className="sp-section-title">Completed Modules</span>
        <span className="sp-section-count">{modules.length}</span>
      </div>

      {modules.length === 0 ? (
        <p className="sp-empty">No modules completed yet.</p>
      ) : (
          ...
          {modules.map((l, i) => (
            ...
            >
              ...
              <div className="sp-row-body">
                <span className="sp-row-title">{l.module_title}</span>
