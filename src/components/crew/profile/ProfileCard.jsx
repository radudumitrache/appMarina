import '../../css/crew/profile/ProfileCard.css'
    ...
    <aside className="profile-aside">
      <div className="profile-card" style={{ animationDelay: '0s' }}>
        ...
        <div className="profile-id-block">
          ...
          <span className="profile-registration-id">{profile.registrationId}</span>
          <span className="profile-role-badge">Crew Member</span>
        </div>
