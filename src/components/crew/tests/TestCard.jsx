...
import '../../css/crew/tests/TestCard.css'
        ...
        <div className="test-card-right">
          ...
          {canRetake && (
            <button
              ...
              onClick={() => navigate(`/crew/tests/${test.id}`)}
            >
              Retake
  ...
  return (
    ...
    >
      ...
      <div className="test-card-action">
        <button className="test-start-btn" aria-label="Start test" onClick={() => navigate(`/crew/tests/${test.id}`)}>
          Start
          <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
