import '../../css/student/progress/LessonsProgress.css'
...
export default function LessonsProgress({ lessons }) {
  if (lessons.length === 0) {
    return (
      <section className="progress-section">
        ...
        <p className="lp-empty">No lessons assigned to your classes yet.</p>
      </section>
    )
  }
    ...
    <section className="progress-section">
      ...
      <div className="lp-body">
        {[...classMap.values()].map(cls => {
          const clsDone  = cls.lessons.filter(l => l.completed).length
          const clsTotal = cls.lessons.length
