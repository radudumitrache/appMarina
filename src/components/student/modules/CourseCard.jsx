...
import '../../css/student/modules/CourseCard.css'
            ...
            modules.map((cl, i) => {
              ...
              if (cl.test) {
                ...
                return (
                  <div
                    ...
                    onClick={() => !isLocked && navigate(`/student/tests/${cl.test}`)}
                    role={isLocked ? undefined : 'button'}
                    tabIndex={isLocked ? undefined : 0}
                    onKeyDown={e => { if (!isLocked && (e.key === 'Enter' || e.key === ' ')) navigate(`/student/tests/${cl.test}`) }}
                  >
              ...
              return (
                <div
                  ...
                  onClick={() => !isLocked && navigate(`/student/modules/${cl.module}`, { state: { module: ld } })}
                  role={isLocked ? undefined : 'button'}
                  tabIndex={isLocked ? undefined : 0}
                  onKeyDown={e => { if (!isLocked && (e.key === 'Enter' || e.key === ' ')) navigate(`/student/modules/${cl.module}`) }}
                >
                  <span className="crs-module-num">{String(i + 1).padStart(2, '0')}</span>
